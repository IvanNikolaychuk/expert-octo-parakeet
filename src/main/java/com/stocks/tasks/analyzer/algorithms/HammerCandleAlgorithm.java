...
import static com.stocks.core.api.helpers.Constants.MAX_ACCEPTED_UPPER_SHADOW_FROM_TOTAL_LENGTH_PERCENTAGE_FOR_HAMMER;
import static com.stocks.core.api.helpers.Constants.MIN_ACCEPTED_LOWER_SHADOW_FROM_TOTAL_LENGTH_PERCENTAGE_FOR_HAMMER;
import static com.stocks.tasks.analyzer.trend.TrendAnalyser.Movement.DOWN;
import static com.stocks.tasks.analyzer.trend.TrendAnalyser.Movement.NONE;
import static com.stocks.tasks.analyzer.trend.TrendAnalyser.Movement.STRONG_DOWN;
import static com.stocks.tasks.analyzer.trend.TrendAnalyser.analyseTrendBefore;
