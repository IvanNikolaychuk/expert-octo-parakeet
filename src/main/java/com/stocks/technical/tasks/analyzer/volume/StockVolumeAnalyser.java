package com.stocks.technical.tasks.analyzer.volume;

import com.stocks.technical.core.db.dao.VolumeStatisticDataDao;
...
import static com.stocks.technical.tasks.utils.CandleUtils.getFirst;
