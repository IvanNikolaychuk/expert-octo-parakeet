...
import com.stocks.technical.core.db.dao.strongbull.AfterPatternStatisticDao;
...
import static com.stocks.technical.tasks.utils.CandleCommonOperations.candleBrokeSupport;
import static com.stocks.technical.tasks.utils.CandleUtils.calculatePercentageProfit;
import static com.stocks.technical.tasks.utils.filters.CandlesFilter.filterByPattern;
