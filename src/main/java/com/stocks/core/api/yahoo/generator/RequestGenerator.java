package com.stocks.core.api.yahoo.generator;
...
public class RequestGenerator {
    private static final String BASE_URL = "https://query2.finance.yahoo.com/v8/finance/chart/{0}?formatted=true" +
            "&crumb=BEbgjvn1CG8&lang=en-US&region=US&period1={1}&period2={2}&interval=1d&events=div%7Csplit&corsDomain=finance.yahoo.com";
